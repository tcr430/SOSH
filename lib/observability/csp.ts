export function buildCsp(
  ...
  const directives: string[] = [
    ...
    `font-src 'self'`,
    `connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.stripe.com https://*.sentry.io https://*.ingest.sentry.io https://*.vercel-insights.com https://vitals.vercel-insights.com`,
