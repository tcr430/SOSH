...
//   1. lib/studio/verify.ts           — THIS FILE. Studio suggestions vs a CitableContext bound at send time;
//                                       has a `rejected` arm above FABRICATION_REJECT_THRESHOLD.
//   2. lib/signals/triage/verify.ts   — Mode 3 Stage C card citations vs the set the triage tools returned.
