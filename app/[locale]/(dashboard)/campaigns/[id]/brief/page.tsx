...
export default async function CampaignBriefPage({ params }: Props) {
  ...
  // listPlanProposalsForBrief. Capability is user_can(business_id,'author'), REUSED (A-5): a UX echo only — the
  // RPCs enforce it.
  ...
  const proposals = await listPlanProposalsForBrief(client, brief.id)
