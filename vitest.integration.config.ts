...
// Session 22-D (MAJOR-1) — the opt-in home for the four real-network
// __integration__ suites (postiz-provider, purge-business, email round-trip,
// marketing route smoke). These are ABSENT from vitest.config.ts's default
...
//
//   POSTIZ_INTEGRATION_TEST_ENABLED=true npx vitest run --config vitest.integration.config.ts lib/social
...
//
// Each suite's own env flag still gates whether it exercises real Postiz/
